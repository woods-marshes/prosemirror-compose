...
internal val claudeCannedReplies: List<String> = listOf(
    ...
    """
        ...
        `ProseMirrorState` exposes `registerTrigger(...)` so you can wire `@`, `#`, or `/` to any popup you like. The library tracks the active query for you via `state.activeTriggerQuery`, and you commit a selection with `RichSpanStyle.Token`.
