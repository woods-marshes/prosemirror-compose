...
import com.github.wood.prosemirror.compose.ui.UndoBehavior
 ...
 *
 * @param state [RichTextState] that holds the state of the [ProseMirrorEditor].
...
/**
 * A draw modifier that draws a bottom indicator line in [ProseMirrorEditor]
 */
