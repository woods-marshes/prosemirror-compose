...
import com.github.wood.prosemirror.compose.clipboard.ClipboardEventEffect
import com.github.wood.prosemirror.compose.clipboard.createProseMirrorClipboardManager
 ...
 * needed.
 *
 * @param state [RichTextState] that holds the state of the [BasicProseMirrorEditor].
 * @param modifier optional [Modifier] for this text field.
 * @param enabled controls the enabled state of the [BasicProseMirrorEditor]. When `false`, the text
 * field will be neither editable nor focusable, the input of the text field will not be selectable
 * @param readOnly controls the editable state of the [BasicProseMirrorEditor]. When `true`, the text
 ...
 */
@Composable
public fun BasicProseMirrorEditor(
...
public fun BasicProseMirrorEditor(
    ...
    val richClipboardManager = remember(state, clipboard) {
        createProseMirrorClipboardManager(
            proseMirrorState = state,
            clipboard = clipboard
        )
    }

    ClipboardEventEffect(proseMirrorState = state)
...
public typealias RichTextChangedListener = (ProseMirrorState) -> Unit
