...
import com.github.wood.prosemirror.compose.ui.BasicProseMirrorText

/**
 * High-level element that displays rich text and provides semantics / accessibility information.
 * [ProseMirrorText] is a convenience wrapper around [Text] and [ProseMirrorState] to allow for rich text.
 *
 * @param state [ProseMirrorState] The rich text to be displayed.
