...
public interface RichSpanStyle {
        public val spanStyle: (ProseMirrorConfig) -> SpanStyle
        ...
        /**
         * Atomic token produced by committing a trigger query (see [com.github.wood.prosemirror.compose.model.trigger.Trigger]).
         *
         ...
         *
         * @property triggerId Id of the [com.github.wood.prosemirror.compose.model.trigger.Trigger] that produced this token.
