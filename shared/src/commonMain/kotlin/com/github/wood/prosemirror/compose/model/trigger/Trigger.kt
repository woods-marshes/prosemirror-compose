package com.github.wood.prosemirror.compose.model.trigger
 ...
 * Receives the live [ProseMirrorConfig] so colors can follow the editor theme.
...
public class Trigger(
    ...
    public val style: (ProseMirrorConfig) -> SpanStyle = { SpanStyle(color = it.linkColor) },
    public val drawStyle: (DrawScope.(TextLayoutResult, TextRange, ProseMirrorConfig, Float, Float) -> Unit)? = null,
